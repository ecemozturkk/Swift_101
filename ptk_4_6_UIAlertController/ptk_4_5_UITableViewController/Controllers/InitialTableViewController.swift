...
//  ptk_4_5_UITableViewController
//
//  Created by Ecem Öztürk on 8.08.2022.
//
...
class InitialTableViewController: UITableViewController {
    ...
    var tableViewData = [
    ["General", "Erişilebilirlik", "Gizlilik"],
    ["Parolalar"],
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let alertController = UIAlertController(title: "Uyarı",
                                                message: tableViewData[indexPath.section][indexPath.row], preferredStyle: .alert)
